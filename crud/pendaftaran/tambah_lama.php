        ...
        if ($result = mysqli_query($con, $sql)) {
          if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_array($result)) {
              ...
              echo "<a class='btn btn-sm ml-1 mb-1 btn-success btn-edit' href='form_data_lama.php?id=" . $row['no_pendaftaran'] . "' title='Edit Pendaftaran' data-toggle='tooltip'>Tambah Data Lama</a>";
              echo "</td>";
              echo "</tr>";
            }
            echo "</tbody>";
