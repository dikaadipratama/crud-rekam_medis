...
<div class="container-fluid">
  <!-- Page Heading -->
  <h1 class="h3 mb-3 text-gray-800">Edit Data Pendaftaran</h1>
      ...
      <form action="proses.php" method="post">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" name="no_pendaftaran" id="no_pendaftaran" class="form-control" value="<?= $data['no_pendaftaran']; ?>" required readonly>
          </div>
          <div class="form-group col-md-6">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" name="tgl_pendaftaran" id="tgl_pendaftaran" class="form-control" value="<?= $data['tgl_pendaftaran']; ?>" required readonly>
          </div>
          <div class="form-group col-md-6">
        ...
        <button type="submit" name="edit" class="btn btn-info">Kirim</button>
        <a href="edit.php" class="btn btn-warning">Kembali</a>
      </form>
    </div>
  </div>
</div>
